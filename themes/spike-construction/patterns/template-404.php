<?php
 /**
  * Title: Template 404
  * Slug: spike-construction/template-404
  * Categories: template
  * Inserter: false
  */
?>
...
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'spike-construction' ); ?></p>
<!-- /wp:paragraph -->
