...
/**
 * Title: Latest Posts
 * Slug: spike-construction/latest-posts
...
<div class="wp-block-group alignfull has-surface-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xx-large);padding-bottom:var(--wp--preset--spacing--xx-large)"><!-- wp:columns {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|large"},"blockGap":{"top":"0","left":"0"},"padding":{"right":"0","left":"0","top":"0","bottom":"0"}}}} -->
<div class="wp-block-columns" style="margin-bottom:var(--wp--preset--spacing--large);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"20%"} -->
...
<h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:700"><?php echo esc_html__( 'OUR COMPLETE ACTIVITIES', 'spike-construction' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<!-- wp:group {"className":"is-style-bk-box-shadow","style":{"spacing":{"blockGap":"var:preset|spacing|xx-small","padding":{"top":"0","bottom":"var:preset|spacing|medium","right":"0","left":"0"}},"border":{"radius":"0px"}},"backgroundColor":"accent-text","layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group is-style-bk-box-shadow has-accent-text-background-color has-background" style="border-radius:0px;padding-top:0;padding-right:0;padding-bottom:var(--wp--preset--spacing--medium);padding-left:0"><!-- wp:post-featured-image {"isLink":true,"width":"","height":"","style":{"border":{"radius":"0px"},"layout":{"selfStretch":"fit","flexSize":null}}} /-->
...
<!-- wp:post-excerpt {"moreText":"","excerptLength":12,"className":"link-no-underline","fontSize":"small"} /-->
