 ...
 * Info Admin Menu
 */
if ( ! class_exists( 'Spike_Construction_Theme_Info' ) ) {
    class Spike_Construction_Theme_Info{
        ...
        public function __construct( $config ) {
            ...
            /* Admin menu */
            add_action( 'admin_menu', array( $this, 'spike_construction_admin_menu' ) );
        ...
        public function prepare_class() {
            ...
            $this->page_title    = $this->theme_name . esc_html__( ' Info', 'spike-construction' );
        }
        
        /**
         * Adding Theme Info Menu under Appearance.
         */
        function spike_construction_admin_menu() {
            if ( ! empty( $this->page_title ) ) {
                add_theme_page( $this->page_title, esc_html__( 'Spike Construction Theme', 'spike-construction' ), 'edit_theme_options', $this->theme_slug . '-info', array(
                    $this,
                    'spike_construction_theme_info_screen',
                ) );
            }
        }
         ...
         */
        public function spike_construction_theme_info_screen() {
            ...
            if (
                ...
                echo '<a href="' . esc_url( 'https://kortezthemes.com/spike-construction-pro/' ).'" target="_blank">';
        ...
        public function style_and_scripts() {
            wp_enqueue_style( 'spike-construction-theme-info-css', get_template_directory_uri() . '/inc/admin/info.css' );
...
$config = array(
    ...
    // Main welcome title
    'info_title' => sprintf( esc_html__( 'Welcome to %s - ', 'spike-construction' ), $theme_name_config ),

    // Main welcome content
    'info_content' => sprintf( esc_html__( 'Spike Construction Pro offers more features and enhances your experience!', 'spike-construction' ), '<b>'.$theme_name_config.'</b>' ),
    ...
    'quick_links' => array(
        'theme_url'  => array(
            'text' => __( 'Buy Pro', 'spike-construction' ),
            'url' => 'https://kortezthemes.com/spike-construction-pro/'
        )
    ),
);

return new Spike_Construction_Theme_Info( $config );